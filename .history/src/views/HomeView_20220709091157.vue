...
const { increment, decrement, counter } = storeToRefs(useCounterStore())


const handelIncrement = () => {
  increment()
}
const handelDecrement = decrement
...
<template>
  <div id="home" class="h-screen bg-slate-400 grid place-items-center">
    ...
    <div class="count-to flex items-center gap-3">
      <button @click="handelDecrement" class="btn">-</button>
      <input :value="counter" type="text" placeholder="conter" class="input w-full max-w-xs" />
      <button @click="handelIncrement" class="btn">+</button>
